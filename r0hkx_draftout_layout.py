...
row3 = row2 + 48
row4 = row3 + 48
# add_image(key="BACKQUOTE", pos=(572, row0), pressed_image="images/gui4/Sprint.png") doesn't work with danish char
add_image(key="ESCAPE", pos=(620, row1), pressed_image="images/gui4/Esc.png")
add_image(key="TAB", pos=(496, row2), pressed_image="images/gui4/Pick Block.png")
...
add_image(key="R", pos=(828, row2), pressed_image="images/gui4/F3.png")
# add_image(key="CAPS_LOCK", pos=(604, row3), pressed_image="images/gui4/Chat.png") works but i don't want it anymore idt
...
add_image(key="SHIFT_L", pos=(600, row4), pressed_image="images/gui4/Shift.png")
