...
row3 = 828
row4 = 864
add_image(key=c("BACKQUOTE"), pos=(657, row1), pressed_image="images/Sprint.png")
add_image(key=c("ESCAPE"), pos=(693, row2), pressed_image="images/Esc.png")
add_image(key=c("TAB"), pos=(753, row2), pressed_image="images/F5.png")
